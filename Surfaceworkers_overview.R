...
pooled_SMR_SW <- metagen(TE = logSMR_1,
                         ...
                         method.tau = "REML",
                         method.random.ci = "HK")
pooled_SMR_SW #Viewing pooled results
#Creating forest plot
forest_SW <- forest(pooled_SMR_SW,
                        sortvar = logSMR_1, 
...
forest_SW.1 <- forest(pooled_SMR_SW,
                     sortvar = logSMR_1,
                     comb.random = TRUE,#Use random effects mode
                     comb.common = FALSE,
                     print.random = TRUE,
...
#Exporting PNG image
png('forest_SW.1.png', width = 900, height = 400)
dev.off()
